...
type DB_AppInfo struct {
	...
	FreeUpKeyInterval int   `json:"FreeUpKeyInterval" gorm:"column:FreeUpKeyInterval;default:0;comment:X秒内可免费换绑次数"`
	//()秒可换绑次数
	UpKeyTime     int64 `json:"UpKeyTime" gorm:"column:UpKeyTime;default:60;comment:X秒内可换绑"`
	UpKeyInterval int   `json:"UpKeyInterval" gorm:"column:UpKeyInterval;default:60;comment:X秒内可换绑次数"`
	//换绑扣时(点)

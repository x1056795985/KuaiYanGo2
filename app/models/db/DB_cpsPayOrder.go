...
type DB_CpsPayOrder struct {
	...
	PayOrder string  `json:"payOrder" gorm:"column:payOrder;size:191;uniqueIndex:idx_db_cps_pay_order_pay_order;comment:余额充值订单id"` //唯一索引,那个线程插入成功,那个处理
	Time     int64   `json:"time" gorm:"column:time;index:idx_db_cps_pay_order_time;comment:时间"`
	...
	InviterId       int     `json:"inviterId" gorm:"column:inviterId;index:idx_db_cps_pay_order_inviter_id;comment:邀请人id"`
	...
	GrandpaId       int     `json:"grandpaId" gorm:"column:grandpaId;index:idx_db_cps_pay_order_grandpa_id;comment:上上级邀请人id"`

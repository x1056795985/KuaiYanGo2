...
## 为什么免费并开源
这个原来是收费的,不过这个网络验证领域卷的厉害,花费时间解决问题,还不赚钱,想想放弃算了,但是做这还是用了很多心思的,放着吃灰感觉又有点可惜,  
会go的直接改就行,完全开源,没有代码混淆,或代码加密.  
注意只花时间解决反馈的bug,已经完全免费开源,所以我不花费时间提供任何其他技术支持,请自己研究
